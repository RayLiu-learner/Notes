<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yijiancharu.aspx.cs" Inherits="_20171847126_刘瑞.yijiancharu" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="name" DataSourceID="SqlDataSource1" Height="299px" Width="350px">
            <EditItemTemplate>
                name:
